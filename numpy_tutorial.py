...
array_27=np.array([[1,2,3,4,4],[4,5,6,7,8]])
print(array_27.ndim)
print(array_27.shape)
print(array_27.size)
print(array_27.itemsize)
array_28=np.arange(15).reshape((3,5)) #<--- arange Is Analogus to Range(Start,Stop,Stepsize)
print(array_28)
print(type(array_28))
array_29 = np.array([(1.5,2,3), (4,5,6)])
print(array_29)
array_30=np.array([[1,2],[3,4]],dtype='complex')
print(array_30)
array_31=np.empty((3,3),dtype='float64') #<---- By Default The Dtype Is Set As Float64
print(array_31)
array_32=np.linspace(0,4,8) #<---- linspace(Start,Stop,Number of Element We Want)
print(array_32)
array_33=np.ones_like(array_27,dtype='int32')
print(array_33)
print(np.linspace(1,2,10000).reshape(100,100))
array_34=np.arange(0,15).reshape(3,5)
array_35=np.arange(0,15).reshape(5,3)
print(array_34 @ array_35) #<--- We Use @ For Matrix Multiplication
print(np.random.random((2,3))) #<--- Another Matrix Making Method
print(array_35)
print(array_35.sum(axis=0)) #<--- Sum of Each Column
print(array_35.sum(axis=1)) #<----Sum of Each Row
print(array_35.min(axis=0)) #<---- Min of Each Column
print(array_35.min(axis=1)) #<--- Min of Each Row
def f(x,y):
    return 10*x+y
...
for element in b.flat:
    print(element)
array_36=np.ceil(10*np.random.random((3,4))) #<---- Another Method to Make An Array
print(array_36)
print(array_36.T) #<---- Transpose of The Matrix
print(array_36.shape)
print(array_36.ravel()) #<----Flatten's The Matrix's Element's
print(array_36.T.shape)
print(array_36.shape)
array_37=np.floor(10*np.random.random((4,4)))
print(np.linalg.eig(array_37)) #<--- Eigenvector But Array Should Be Square
print(np.linalg.inv(array_37)) #<---- Inverse
print(np.linalg.det(array_37)) #<---- Determinant
print(np.trace(array_37))      #<---- Trace
print(np.eye(2,dtype='int32'))
print(np.iinfo(int))
print(np.iinfo('int64'))
array_38=np.eye(2,dtype='int32')
array_39=np.eye(2,dtype='int32')
print(array_38+array_39)
